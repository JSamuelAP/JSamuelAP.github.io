...
import kafkaSvg from '../assets/images/skills/kafka.svg';
import linuxSvg from '../assets/images/skills/linux.svg';
import mysqlSvg from '../assets/images/skills/mysql.svg';
import nodejsSvg from '../assets/images/skills/nodejs.svg';
import postgresqlSvg from '../assets/images/skills/postgresql.svg';
...
export const skills: Record<string, Skill[]> = {
  backend: [
    ...
    { name: 'PostgreSQL', src: postgresqlSvg, description: 'Sistema de gestión de bases de datos relacional' },
    { name: 'Kafka', src: kafkaSvg, description: 'Plataforma de mensajería distribuida' },
  ],
  frontend: [
  ...
  otras: [
    ...
    { name: 'Docker', src: dockerSvg, description: 'Plataforma de contenedores' },
    { name: 'Linux', src: linuxSvg, description: 'Sistema operativo de código abierto' },
